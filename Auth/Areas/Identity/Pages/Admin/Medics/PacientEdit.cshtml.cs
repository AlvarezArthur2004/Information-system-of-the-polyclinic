...
{
    public class PacientEditModel : PageModel
    {
        ...
        public PacientEditModel(IWebHostEnvironment environment, ApplicationDBContext context)
        {
        ...
        public void OnPost(string id)
        {
            ...
            Response.Redirect("/Identity/Admin/Medics/IndexPacient");
        }
    }
}
